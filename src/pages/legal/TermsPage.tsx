...
export const TermsPage = () => {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl prose dark:prose-invert">
      ...
      <p>By accessing or using Nova 3D, you agree to be bound by these Terms of Service.</p>
      ...
      <p>Nova 3D shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service.</p>
    </div>
  );
};
