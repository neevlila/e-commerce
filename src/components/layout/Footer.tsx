...
export const Footer = () => {
  return (
    <footer className="bg-gray-50 dark:bg-slate-900 border-t border-border mt-auto transition-colors duration-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h3 className="font-bold text-foreground mb-4 text-lg">Nova 3D</h3>
        ...
        <div className="mt-12 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Nova 3D. All rights reserved.
        </div>
      </div>
    </footer>
  );
